  ...
  visitorForm.addEventListener("submit", async e=>{
    ...
    */
    ...
    try{
      ...
      /*
      Make sure Netlify actually accepted
      the form submission.
      */
      ...
      */
      ...
      /*
      Store a local backup if the online
      submission fails.
      */
      ...
      alert(
        "The message could not be sent right now. Please use the Contact Details button to reach me directly."
      );
